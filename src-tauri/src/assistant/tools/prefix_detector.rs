...
const NO_SUBCOMMAND: &[&str] = &[
    // File/text utilities
    "ls", "cat", "less", "more", "head", "tail", "cp", "mv", "ln", "mkdir", "rmdir", "touch",
    "stat", "file", "wc", "sort", "uniq", "tr", "cut", "tee", "rev", "tac", "grep", "egrep",
    "fgrep", "rg", "ag", "ack", "find", "fd", "locate", "which", "whereis", "readlink",
    "realpath", "basename", "dirname",
    // System info
    "pwd", "echo", "printf", "date", "whoami", "hostname", "uname", "id", "uptime", "free", "df",
    "du", "ps", "kill", "killall", "pidof", "top", "htop", "nproc",
    // Test / trivial
    "true", "false", "sleep", "yes", "seq", "expr",
    // Network probes
    "ping", "traceroute", "host", "dig", "nslookup", "curl", "wget", "nc",
    // Diff / archive
    "diff", "patch", "tar", "gzip", "gunzip", "zip", "unzip",
    // Hashing / encoding
    "md5sum", "sha1sum", "sha256sum", "base64", "hexdump", "xxd",
];
...
const ONE_WORD: &[&str] = &[
    "git", "docker", "podman", "npm", "yarn", "pnpm", "cargo", "make", "go", "terraform",
    "tofu", "helm", "flatpak", "apt", "apt-get", "dpkg", "yum", "dnf", "pacman", "snap",
    "pip", "pip3", "pipx", "poetry", "uv", "systemctl", "journalctl", "brew", "rustup",
    "deno", "bun", "tsc", "ruff", "black", "mypy", "pytest",
];
